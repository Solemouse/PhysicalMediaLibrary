...
CREATE TABLE Media_Names (
    ...
    FOREIGN KEY (type_id) REFERENCES Media_Types(id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Active_Loans (
    ...
    FOREIGN KEY (renter_id) REFERENCES Renters(id) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (media_id) REFERENCES Media_Names(id) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (home_id) REFERENCES Locations(id) ON DELETE CASCADE ON UPDATE CASCADE
);